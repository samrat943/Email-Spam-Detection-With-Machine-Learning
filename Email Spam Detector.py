...
dummy = " "
message = " "
h_text = "Click to classify the spam or ham mail"

page = """
<|text-center|
#
# Email **Spam**{:.color-primary} Detector
|>
...
def on_button_action(state):
    notify(state, 'info', f'Results may be inaccurate due to limited dataset. Thanks for using this Application')
